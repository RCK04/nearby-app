...
export default function Market(){
    ...
    const [isVisibleCameraModal, setIsVisibileCameraModal] = useState(false)
    ...
    async function handleOpenCamera(){
        try {
            ...
            if(!granted){
                return Alert.alert("Câmera", "Vocẽ precisa habilitar o uso da câmera")
            }
    ...
    function handleUseCoupon(id: string){
        ...
        Alert.alert(
            "Cupom",
            "Não é possível reutilizarum cupom resgatado. Deseja realmente resgatar o cupom?",
            [
